...
import com.meda.blowup.monsters.Minion;
import com.meda.blowup.monsters.Monster;
import com.meda.blowup.monsters.PurpleMonster;
import com.meda.blowup.util.Configuration;
import com.meda.blowup.util.Constants;

public class PurpleMonsterLayer extends GameLayer {
	public PurpleMonsterLayer(Configuration conf, CCTexture2D groundTexture) {
		super(groundTexture);
	...
	public void createMonsters() {
		...
		for (int i = 0; i < getMonsterCount(); i++) {
			...
			circle.m_radius = 60f / Constants.PTM_RATIO
		...
		for (int i = 0; i < getMinionCount(); i++) {
			...
			circle = new CircleShape();
			circle.m_radius = 20f / Constants.PTM_RATIO
					* Constants.SCALE_FACTOR;
			fixtureDef = new FixtureDef();
			fixtureDef.shape = circle;
			fixtureDef.density = 1.0f;

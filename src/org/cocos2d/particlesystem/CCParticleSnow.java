...
public class CCParticleSnow extends CCQuadParticleSystem {
	...
	protected CCParticleSnow(int p) {
		...
		this.setPosition(CGPoint.ccp(winSize.width / 2, winSize.height));
		...
		texture = CCTextureCache.sharedTextureCache().addImage("snow.png");

		// size, in pixels
		startSize = texture.getWidth() * 5;
		startSizeVar = texture.getWidth() * 3;
